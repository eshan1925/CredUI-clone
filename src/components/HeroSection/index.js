...
const HeroSection = () => {
    return <div className='hero-section-wrapper'>
        <div className='flex absolute-center hero-claim-label'>
            <div>pay credit card bill. earn guaranteed Rs. 100 back.</div>
            <div className='claim-anchor'>
                claim now <img src="https://web-images.credcdn.in/_next/assets/images/home-page/arrow.png" alt='claim-arrow' className='claim-arrow' />
            </div>
        </div>
